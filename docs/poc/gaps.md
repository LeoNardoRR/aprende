...
| POC-1.10 | VAAR/equidade | Cenário não demonstrável. | Fase 7. | Implementar metodologia após homologação dos indicadores. | XL |
| POC-1.11 | Fluência leitora | Cenário não demonstrável. | Fase 7. | Projetar captura, rubrica e revisão humana. | XL |
| POC-1.12 | Recomposição | Tarefas/pontos não cobrem objetos e jornadas exigidos. | Fase 7 e conteúdo externo. | Construir domínio de jornadas e catálogo homologado. | XL |
| POC-1.13 | IA pedagógica | Cenário não demonstrável. | Fase 7, provedor e privacidade. | Implementar somente com validação humana e DPIA. | XL |
