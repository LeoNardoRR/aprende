...
export function AnalyticsDashboard({ mode, networks = [], schools = [], classrooms = [], fixedNetworkId, fixedSchoolId, fixedClassroomId, preview = false, onAssignSkill }: AnalyticsDashboardProps) {
