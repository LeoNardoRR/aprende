...
import { ArrowLeft, Bell, BookOpen, CheckCircle2, GraduationCap, LoaderCircle, LogOut, School, Send, Trophy, UserMinus, Users, X } from 'lucide-react';
...
export function StudentConnect({ onClose, allowClose = true, pageMode = false, onOpenTeacher, onChanged }: StudentConnectProps) {
