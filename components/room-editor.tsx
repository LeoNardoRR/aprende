...
import { Check, X, Save, Sparkles, Image, UserRound, Dices, RotateCcw, Scissors, Eye, Shirt, Glasses, Palette, Type, Shapes, MousePointer2, Star, Heart, ArrowUpRight } from 'lucide-react';
